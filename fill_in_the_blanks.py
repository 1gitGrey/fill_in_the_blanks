...
def easySpaces():
	...
	question = "On November 8, 2016, Donald ____1____ stunned millions of people worldwide when he won the ____2____ election. His opponent ____3____ Clinton could not deliver her concession speech as intended due to the shock of the outcome. Nevertheless, she did ____4____ to him. Despite losing the electoral college vote, she did win the ____5____ vote."

	user_responses = ["", "", "", "", "", ""]
	correct_responses = ["Trump", "Presidential", "Hillary", "concede", "popular"]
